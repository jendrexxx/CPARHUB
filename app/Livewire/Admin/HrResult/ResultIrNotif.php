...
class ResultIrNotif extends Component
{
    ...
    {
        $this->dispatch('open-nte-cpar', id: $assignment_id);
    }

    public function render()
    {
        return view('livewire.admin.hr_result.result_ir_notif');
    }
}
