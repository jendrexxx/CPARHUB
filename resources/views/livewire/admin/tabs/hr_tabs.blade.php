            ...
            <table class="w-full min-w-[1200px] text-sm">
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    ...
                    <tr class="text-center hover:bg-zinc-50 dark:hover:bg-zinc-800 transition">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
                        ...
                        <td class="px-4 py-4">
                            <div class="flex flex-wrap justify-center gap-1">
                                ...
                                <span class="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium bg-red-100 text-red-700 dark:bg-red-950 dark:text-red-400">
                                    {{ $decision }}
                                </span>
                                @endforeach
                                @else
                        ...
                        <td class="px-4 py-4">
                            ...
                            <div class="flex flex-wrap justify-center gap-2">
                                ...
                                <span class="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-400">
                                    NTE Submitted
                                </span>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            ...
                            <span class="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium bg-yellow-100 text-yellow-700 dark:bg-yellow-950 dark:text-yellow-400">
                                {{ $cpar->status_name }}
                            </span>
                    ...
                    <tr>
                        ...
                        <td colspan="10" class="px-4 py-12 text-center">
                            ...
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <div class="flex items-center justify-center w-12 h-12 rounded-full bg-green-100 dark:bg-green-950">
