    ...
    <flux:modal name="master-file-modal" class="w-full max-w-7xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-5">
                ...
                <flux:select
                    ...
                    wire:model="selectedHRDecisions"
                    placeholder="Select Decision Category">

                    @foreach ($decisionCategories as $decision)

                    <flux:select.option value="{{ $decision->id }}">
                        {{ $decision->decision_name ?? $decision->name ?? '-' }}
                    </flux:select.option>
        ...
        <div class="space-y-5">
            ...
            <div>
                ...
                <flux:text class="mt-1">
                    Review and replace the IR attachment if necessary.
                </flux:text>
            </div>
            ...
            <div>
                ...
                <div class="mt-2 flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <a
                        ...
                        target="_blank"
                        download
                        class="ml-4 rounded-lg bg-gray-900 px-3 py-2 text-xs font-medium text-white hover:bg-gray-700 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-200">
