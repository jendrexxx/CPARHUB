<flux:modal name="ResultIRModal" class="w-[120%] max-w-[1500px] mt-6 top-0 z-50">
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <flux:text class="mt-1">
                Review the Result Concern details and process the corresponding NTE request.
            </flux:text>
        </div>
                            ...
                            <td class="px-4 py-3 text-center">
                                <flux:dropdown align="end">
                                    ...
                                    <flux:menu>
                                        <flux:menu.item
                                            icon="document-text"
                                            wire:click="ViewNTE({{ $request->assignment_id }})">
                                            View NTE
                                        </flux:menu.item>
                                    </flux:menu>
                                </flux:dropdown>
