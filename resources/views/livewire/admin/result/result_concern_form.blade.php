<flux:modal name="ResultSubmissionModal" class="w-[120%] max-w-[1500px] mt-6 top-0 z-50">

    <div class="space-y-6">

        <div>
            <flux:heading size="lg">
                Result Acknowledgement Concern
            </flux:heading>

            <flux:text class="mt-1">
                Below is the list of your filed Result Acknowledgement Concern.
            </flux:text>
        </div>
                            ...
                            <td class="px-4 py-3 text-center">
                                <flux:dropdown align="end">
                                    ...
                                    <flux:menu>
                                        <flux:menu.item
                                            icon="document-text"
                                            wire:click="ViewAcknowledgement({{ $request->assignment_id }})">
